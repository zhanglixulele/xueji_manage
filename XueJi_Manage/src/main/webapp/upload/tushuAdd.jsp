...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script type="text/javascript" src="<%=path %>/src/main/webapp/jsc/main/webapp/js/popup.js"></script>
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/src/main/webapp/img/allbg.gif'>
			<form action="" name="form1">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/src/main/webapp/img/main/webapp/img/wbg.gif" class='title'><span>图书添加</span></td>
					    </tr>
